        ...
        <div className="bg-white p-8 rounded-lg shadow-md max-w-md w-full">
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            ...
            >
              ...
              <span className="font-medium">Bypass Login (Testing Only)</span>
            </button>
      ...
      <div className="w-64 bg-white shadow-lg">
        ...
        <div className="p-4">
          <div className="flex items-center space-x-3 mb-6 p-3 bg-gray-50 rounded-lg">
            <div className={`w-8 h-8 ${bypassMode ? 'bg-orange-600' : 'bg-blue-600'} rounded-full flex items-center justify-center`}>
              {bypassMode ? <Shield className="w-4 h-4 text-white" /> : <Users className="w-4 h-4 text-white" />}
            </div>
            <div>
              <p className="text-sm font-medium text-gray-900">
                {bypassMode ? 'Test Admin' : user?.email}
              </p>
              <p className="text-xs text-gray-500">
                {bypassMode ? 'Testing Mode' : 'Administrator'}
              </p>
            </div>
          </div>
          ...
          <div className="mt-8 pt-4 border-t border-gray-200">
            <button
              onClick={bypassMode ? () => setBypassMode(false) : logout}
            ...
            >
              ...
              <span className="font-medium">
                {bypassMode ? 'Exit Test Mode' : 'Logout'}
              </span>
            </button>
          </div>
        </div>
